...
export const PUT: RequestHandler = async ({ url }) => {    
    ...
    const payment_information_id = await Payments.retrieveUserStoredPaymentInformationId(session_id);
    PaymentInformation.registerPaymentInformationId(payment_information_id);
